...
//  slot-machine
//
//  Created by Smit Mahesh Panchal on 6/8/25.
//
        ...
        ZStack {
            ...
            VStack(alignment: .center, spacing: 50) {
                ...
                .alert(item: $showingAlert) { alert -> Alert in
                    ...
                    case .failure:
                        return Alert(title: Text("Ooops!"), message: Text("Better Luch next time"), dismissButton: .cancel())
                    }
                }
